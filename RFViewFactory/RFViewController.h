...
// Called when the activity is first created when fired from an RFIntent. This is where you should do all of your non-GUI setup. For GUI setup, override viewDidLoad.
-(void)onCreate;
